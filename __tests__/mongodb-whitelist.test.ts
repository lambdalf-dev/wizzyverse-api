...
describe('mongodb-whitelist', () => {
  ...
  describe('environment variable validation', () => {
    it('should throw error when WHITELIST_MONGODB_URI is not defined', () => {
      delete process.env.WHITELIST_MONGODB_URI;
      
      // Clear module cache to force re-evaluation
      jest.resetModules();
      
      expect(() => {
        require('@/lib/mongodb-whitelist');
      }).toThrow('Please add your Whitelist Mongo URI to .env.local');
    });

    it('should not throw error when WHITELIST_MONGODB_URI is defined', () => {
      process.env.WHITELIST_MONGODB_URI = 'mongodb://localhost:27017/test';
  ...
  describe('development mode behavior', () => {
    ...
    it('should use global variable in development mode', () => {
      ...
      (global as any)._whitelistMongoClientPromise = undefined;
      ...
      expect((global as any)._whitelistMongoClientPromise).toBeDefined();
    });

    it('should reuse existing global promise in development mode', () => {
      const existingPromise = Promise.resolve({});
      (global as any)._whitelistMongoClientPromise = existingPromise;
  ...
  describe('production mode behavior', () => {
    ...
    it('should not use global variable in production mode', () => {
      ...
      expect((global as any)._whitelistMongoClientPromise).toBeUndefined();
    });
  });
  ...
  describe('module export', () => {
    ...
    it('should export a promise', async () => {
      const clientPromise = require('@/lib/mongodb-whitelist').default;
